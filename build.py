  ...
  <nav class="navbar">
    <div class="container">
      ...
      <div class="nav-links">
        ...
        <a href="{base_path}archive.html">归档</a>
      </div>
    </div>
  </nav>
...
### OpenAI 发布 GPT-5 预览版
OpenAI 宣布开放 GPT-5 模型的有限预览，新模型在推理能力上有显著提升。

### Google DeepMind 推出 Gemini 2.0
继 Gemini 1.5 之后，DeepMind 发布了新一代多模态模型...

## 📰 行业动态

- **Anthropic** 获得新一轮融资
- **Meta** 开源新的 LLaMA 3.5 模型
- **Microsoft** 与 OpenAI 深化合作
...
"""
    ...
    print("📝 Created sample content files")
