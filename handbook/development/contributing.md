...
如果需要追溯早期治理改造的 PR 边界，见归档的 [`project-rollout.md`](../archive/plans/project-rollout.md)；当前变更以独立、可验证的主题提交为准。
...
更详细示例见 [扩展新闻源](source-adapters.md)。
...
- 修改 Tavily CLI、诊断字段、Actions 灰度入口或默认策略时，必须同步更新 [`../operations/tavily.md`](../operations/tavily.md)
