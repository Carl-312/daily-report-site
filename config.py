...
class EnrichmentSettings(BaseModel):
    ...
    min_articles: int = Field(default=5, ge=1, le=20)
    strict_hours: int = Field(default=24)
    max_total_calls: int = Field(default=15, ge=0, le=30)
    max_verify_calls: int = Field(default=3, ge=0, le=20)
    max_refill_rounds: int = Field(default=1, ge=0, le=5)
    ...
    max_lead_candidates: int = Field(default=5, ge=0, le=10)
