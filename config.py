...
class EnrichmentSettings(BaseModel):
    ...
    min_articles: int = Field(default=0, ge=0, le=20)
    strict_hours: int = Field(default=24)
    max_total_calls: int = Field(default=30, ge=0, le=30)
    max_verify_calls: int = Field(default=0, ge=0, le=20)
    max_refill_rounds: int = Field(default=0, ge=0, le=5)
    ...
    max_lead_candidates: int = Field(default=10, ge=0, le=10)
    lead_search_rounds: int = Field(default=2, ge=1, le=3)
    lead_max_results: int = Field(default=5, ge=1, le=10)
    lead_search_depth: Literal["basic", "advanced"] = "advanced"
    lead_max_age_hours: int = Field(default=72, ge=24, le=168)
    lead_min_evidence_chars: int = Field(default=80, ge=20, le=500)
    lead_evidence_chars_per_source: int = Field(default=600, ge=100, le=2000)
    enrichment_deadline_reserve_seconds: int = Field(default=240, ge=60, le=600)
